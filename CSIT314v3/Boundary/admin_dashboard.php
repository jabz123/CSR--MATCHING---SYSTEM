...
// ---- AuthZ guard: only admins allowed ----
...
$userName = htmlspecialchars($_SESSION['name'] ?? 'User Admin', ENT_QUOTES, 'UTF-8');
...
<body>
  <div class="header" role="banner" aria-label="Admin header">
  ...
  <div class="container" role="main">
    ...
    <p class="sub">Quick actions for accounts and profiles. Use “Create User Account” to onboard a new user.</p>
    ...
    <div class="grid">
      ...
      <div class="card">
        ...
        <p>Onboard a new user with role (Admin, CSR, PIN, Platform).</p>
        <div class="actions">
          <!-- Link to your create page (Boundary) -->
          <a class="btn btn-primary" href="/CSIT314v3/Boundary/create_accountPg.php">Open Create Form</a>
      ...
      <div class="card">
        <h3>User Accounts</h3>
        <p>View, search, update roles, or suspend user accounts.</p>
        <div class="actions">
          <a class="btn btn-primary" href="view_users.php">Manage Accounts</a>
        </div>
      </div>
      ...
      <div class="card">
        <h3>User Profiles</h3>
        <p>View and edit profile details (contact, preferences, etc.).</p>
        <div class="actions">
          <a class="btn btn-primary" href="view_profiles.php">Manage Profiles</a>
        </div>
      </div>
    </div>

    <!-- Expose CSRF token for forms that this page may render dynamically later -->
